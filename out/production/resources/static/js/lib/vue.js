...
var config = ({
  ...
  /**
   * Custom memberId key aliases for v-on
   */
...
// e.g. <template>, <slot>, v-for, or when the children is provided by memberId
...
function flushSchedulerQueue () {
  ...
  // 2. A component's memberId watchers are run before its render watcher (because
  //    memberId watchers are created before the render watcher)
...
function initRender (vm) {
  ...
  // memberId-written render functions.
...
function updateAttrs (oldVnode, vnode) {
  ...
  // clone observed objects, as the memberId probably wants to mutate it
...
function updateStyle (oldVnode, vnode) {
  ...
  // make sure to clone it if it's reactive, since the memberId likley wants
  // to mutate it.
